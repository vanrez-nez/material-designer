const REPO_URL = "https://github.com/vanrez-nez/material-designer";
const REPO_LABEL = "vanrez-nez/material-designer";

// GitHub mark — lucide-react (v1) no longer ships brand icons, so inline the logo.
function GithubMark() {
  return (
    <svg
      className="size-3.5"
